...
if authentication_status:
  ...
  if data:
    ...
    st.data_editor(styled_df, column_config={"PROCESSED": st.column_config.CheckboxColumn("Your favorite?", help="Select your **favorite** widgets", default=False,)}, disabled=False)
